# Baldi's Basics Plus Chinese Mod
...
- Baymaxawa (most code)
- DeepSeek & ChatGPT (help with some code)
- [XUnity.AutoTranslator](https://github.com/bbepis/XUnity.AutoTranslator) (reference of some font loading methods)
- [TWGSRussifier](https://github.com/BaldiTomorrowGames/TWGSRussifier) (this mod's base)