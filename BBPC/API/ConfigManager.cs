...
namespace BBPC.API
{
    ...
    public class BBPCOptionsCategory : CustomOptionsCategory
    {
        ...
        public override void Build()
        {
            ...
            LangNotice = CreateText("LangNotice", Plugin.Instance.GetTranslationKey("BBPC_LangNotice", "test"), new Vector2(0, 30), BaldiFonts.ComicSans24, TextAlignmentOptions.Center, new Vector2(50, 50), Color.red);
