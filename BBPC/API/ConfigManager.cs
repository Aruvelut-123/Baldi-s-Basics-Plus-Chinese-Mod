...
namespace BBPC.API
{
    ...
    public class BBPCOptionsCategory : CustomOptionsCategory
    {
        ...
        public override void Build()
        {
            ...
            LangNotice = CreateText("LangNotice", Plugin.Instance.GetTranslationKey("BBPC_LangNotice", ""), new Vector2(0, -60), BaldiFonts.ComicSans24, TextAlignmentOptions.Center, new Vector2(120, 20), Color.red);
