...
namespace BBPC
{
    ...
    internal class OptionsMenuPatch
    {
        ...
        {
            { "ControlsTemp/MapperButton/MapperButton", "BBPC_Menu_MapperButtonText" },
            { "ControlsTemp/SteamButton/SteamInputButton", "BBPC_Menu_SteamInputText" },
            { "ControlsTemp/SteamButton/SteamDesc", "BBPC_Menu_SteamDescText" }
        };
