...
namespace BBPC.Patches
{
    ...
    internal class MainMenuPatch
    {
        ...
        {
            new SocialMediaInfo("QQGroupButton", "BBPC_Menu_QQGroup", "https://qm.qq.com/q/yUXZHYWyNa"),
            new SocialMediaInfo("GameBananaButton", "BBPC_Menu_GameBanana", "https://gamebanana.com/mods/610816"),
            new SocialMediaInfo("ItchButton", "BBPC_Menu_Itch", "https://baymaxqwq.itch.io/baldi-chinese"),
            new SocialMediaInfo("GithubButton", "BBPC_Menu_Github", "https://github.com/Aruvelut-123/Baldi-s-Basics-Plus-Chinese-Mod/"),
            new SocialMediaInfo("YouTubeButton", "BBPC_Menu_YouTube", "https://www.youtube.com/@baymaxawa"),
            new SocialMediaInfo("BilibiliButton", "BBPC_Menu_Bilibili", "https://space.bilibili.com/475655508")
        };
        ...
        private static void ToggleSocialLinksDropdown(Transform? rootTransform, GameObject? modInfoButton)
        {
            ...
            Vector3 new_pos = socialLinksPanel.transform.position;
            new_pos.y = 50;
            socialLinksPanel.transform.position = new_pos;
