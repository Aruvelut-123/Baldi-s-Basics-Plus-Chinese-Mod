...
namespace BBPC.Patches
{
    ...
    internal class EndlessGameManagerPatch
    {
        ...
        {
            { "EndlessGameManager(Clone)/Score/Text", "BBPC_Endless_Text" },
            { "EndlessGameManager(Clone)/Score/Congrats", "BBPC_Endless_Score" },
            { "Medium_EndlessGameManager(Clone)/Score/Text", "BBPC_Endless_Text" },
            { "Medium_EndlessGameManager(Clone)/Score/Congrats", "BBPC_Endless_Score" }
        };
