...
namespace BBPC.ModManagerExtension.Patches
{
    ...
    public class ModManagerPatch
    {
        ...
        public static void BuildPostfix(ModManager.ModManager __instance)
        {
            ...
            TextLocalizer modInfoTL = __instance.modInfo.gameObject.GetComponent<TextLocalizer>() ?? __instance.modInfo.gameObject.AddComponent<TextLocalizer>();
            modInfoTL.key = "MMg_If_See";
            modInfoTL.RefreshLocalization();
            TextLocalizer modNameTL = __instance.modName.gameObject.GetComponent<TextLocalizer>() ?? __instance.modName.gameObject.AddComponent<TextLocalizer>();
            ...
            {
                UnityEngine.Object.Destroy(reloadButton.GetComponent<TextLocalizer>());
            }
