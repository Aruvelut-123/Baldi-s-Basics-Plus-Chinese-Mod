...
namespace BBPC
{
    internal class PauseMenuPatch
    {
        ...
        {
            { "CoreGameManager(Clone)/PauseMenuScreens/PauseScreen/Main/ResumeButton", "BBPC_Pause_ResumeButton" },
            { "CoreGameManager(Clone)/PauseMenuScreens/PauseScreen/Main/OptionsButton", "BBPC_Pause_OptionsButton" },
            { "CoreGameManager(Clone)/PauseMenuScreens/PauseScreen/Main/QuitButton", "BBPC_Pause_QuitButton" },
            { "CoreGameManager(Clone)/PauseMenuScreens/PauseScreen/Main/PauseLabel", "BBPC_Pause_PauseLabel" },
