...
namespace BBPC.Patches
{
    ...
    internal class ElevatorScreenPatch
    {
        ...
        {
            { "ResultsText", "BBPC_Elevator_ResultsText" },
            ...
            { "GradeBonusText", "BBPC_Elevator_GradeBonusText" },
            { "TimeBonusValue", "BBPC_Elevator_TimeBonusValue" },
            { "GradeBonusValue", "BBPC_Elevator_GradeBonusValue" }
        };
